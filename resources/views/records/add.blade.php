    ...
    <div class="panel-body bg-dark" style="color: white">
        ...
        <form id="frm-project">
            <div class="form-group">
                ...
                <div>     
                    <img src=""  id="Chocolate" class="photo" width="100" height="100" data-toggle="modal" data-target="#exampleModal">
                        <b>Chocolate</b>
                </div>
                 

                <div>
                <img src="" id="Mango" class="photo" width="100" height="100" data-toggle="modal" data-target="#exampleModal">
                    <b>Mango</b>
                </div>

                <div>
                <img src="" id="Venila" class="photo" width="100" height="100" data-toggle="modal" data-target="#exampleModal">
                    <b>Venila</b>
                </div>

                <div>
                <img src="" id="Strawberry" class="photo" width="100" height="100" data-toggle="modal" data-target="#exampleModal">
                    <b>Strawberry</b>
                </div>

                <div>
                <img src="" id="MixFruit" class="photo" width="100" height="100" data-toggle="modal" data-target="#exampleModal">
                    <b>MixFruit</b>
                </div>
            </div>
        </form>
...
<div class="col-sm-3">
    ...
    <div>
        ...
        <button type="button" class="btn btn-dark"><i class="fas fa-print">Imprimir Factura</i></button>
    </div>
